		...
		<div class="min-h-full mx-10">
			<div class="flex flex-col md:grid md:grid-cols-6 min-h-full">
				...
				<div class="col-span-4 flex-1 flex-col order-1 md:order-none">
					<div class="container mx-auto max-w-full 2xl:max-w-6xl">
						...
						<footer class="hidden text-center md:block mb-5">
							<p>🚀 Designed & Created by <a href="https://nawres-portfolio.onrender.com/" class="hover:text-link-color" target="_blank">Nawres Boutabba</a></p>
				...
				<footer class="block text-center text-sm md:hidden order-last mb-5">
					<p>🚀 Designed & Created by <a href="https://github.com/nawresboutabba/portVuejs" class="hover:text-link-color" target="_blank">Nawres Boutabba</a></p>
					<a href="https://github.com/nawresboutabba/portVuejs" class="hover:text-link-color" target="_blank">Code available on Github 👾</a>
				</footer>
			</div>
		</div>
